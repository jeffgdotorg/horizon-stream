...
public class ValueTest {
    ...
    public void testBasicList() throws MissingTemplateException, InvalidPacketException {
        ...
        Assert.assertEquals(5930, Long.parseUnsignedLong(((UnsignedValue) listValue.get(0).get(0)).getValue().toString()));
        Assert.assertEquals(3365, Long.parseUnsignedLong(((UnsignedValue) listValue.get(1).get(0)).getValue().toString()));
        Assert.assertEquals(22864, Long.parseUnsignedLong(((UnsignedValue) listValue.get(2).get(0)).getValue().toString()));
    }
